...
public class CopyOfTest {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedImage img = ImageIO.read(new File("D:\\My Imps\\Deans Data\\Answer_Sheets\\B_0008_64.jpg"));
		...
		if (no_of_white == 4) {
			System.out.println("Marked all");// Can be the source for errors
			System.out.println("======================================================");
		}
		else if (no_of_white == 0) {
